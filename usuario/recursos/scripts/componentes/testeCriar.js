    ...
    <div class="usuarios-cadastrados" id="criarNovoCard">
                <div class="card-usuario">
                    ...
                    <img width="20" height="20"
                        ...
                        alt="external-edit-basic-user-interface-anggara-flat-anggara-putra" class="editarUsuario" data-id="${pessoa.ID || pessoa.id}"/>
                    <img width="20" height="20" src="https://img.icons8.com/pulsar-gradient/48/filled-trash.png"
                        alt="filled-trash" class="deletarUsuario" data-id="${pessoa.ID || pessoa.id}"/>
                </div>
            </div>`;
